...
//   // Assume fill, noStroke, and ellipse are p5.js functions or equivalent in your environment

// // Define the canvas range for the y-axis
// const canvasMinY = 55 * s_y;
// const canvasMaxY = 171.25 * s_y;
// const canvasRange = canvasMaxY - canvasMinY;

// // Define the data range for the y-axis based on the factor
// const maxY = Math.pow(10, orderOfMagnitude); // Closest whole power of 10 above the max y-value
// const minY = Math.pow(10, orderOfMagnitude - 1); // Closest whole power of 10 below the max y-value
// const dataRange = maxY - minY;

// // Calculate the normalization factor
// const normalizationFactor = canvasRange / dataRange;

// // Draw the graph with normalized y-values
// fill(255);
// noStroke();
// for (let i = 0; i < new_array_plot_e_set_count.length; i++) {
//     // Normalize the y-value
//     let normalizedY = ((new_array_plot_e_set_count[i].y - minY) * normalizationFactor) + canvasMinY;

//     // Plot the point
//     ellipse(
//         (550 + (400 / 8) * new_array_plot_e_set_count[i].x / 10) * s_x,
//         canvasMaxY - normalizedY/10,
//         3
//     );
// }

// // Label the y-axis with the minimum and maximum significant values
// fill(155); // Assuming black text
// noStroke();
// textAlign(RIGHT, CENTER); // p5.js function for text alignment
// textSize(12); // Set text size


// // Label for minY
// text((100*minY).toExponential(), 250 * s_x, canvasMaxY);
// // Label for maxY
// text((100*maxY).toExponential(), 250 * s_x, canvasMinY);
